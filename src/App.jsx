...
function MainApp() {
  ...
  return (
    <div className="app">
      ...
      <a 
        href="https://survey.theshetalks.club" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="floating-announcement"
      >
        ...
        <div className="announcement-subtitle">Quick health survey • No email needed • 100% anonymous</div>
      </a>
    </div>
  );
}
